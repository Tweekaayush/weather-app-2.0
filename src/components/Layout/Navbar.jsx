...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-center items-center h-16 w-full border-b bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 z-50 relative">
      <div className="container flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <button onClick={()=>setOpen(true)} className="block md:hidden border-2 border-gray-200 dark:border-gray-800 hover:bg-gray-200 dark:hover:bg-gray-800 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 p-2.5 rounded-full cursor-pointer">
